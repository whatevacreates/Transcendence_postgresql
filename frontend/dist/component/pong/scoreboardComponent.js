...
function scoreboardComponent(userIdA, userIdB, userA, userB, scoreA = 0, scoreB = 0) {
  ...
  `);
    // DOM elements
    const avatarA = component.querySelector('[data-id="avatar-player-a"]');
    const avatarB = component.querySelector('[data-id="avatar-player-b"]');
    const nameA = component.querySelector('[data-id="player-a"]');
    const nameB = component.querySelector('[data-id="player-b"]');
    const scoreAEl = component.querySelector('[data-id="score-a"]');
    const scoreBEl = component.querySelector('[data-id="score-b"]');
    // Set names
