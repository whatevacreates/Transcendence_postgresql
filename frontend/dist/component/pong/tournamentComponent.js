...
function tournamentComponent(props) {
    const semiFinals = props.semiFinals || [];
    let final = props.final || null;
  ...
  `);
    const semifinalContainer = component.querySelector('div.grid-flow-row.grid-rows-2');
    const finalContainer = component.querySelector('div.mx-2.grid');
    const renderMatches = () => {
