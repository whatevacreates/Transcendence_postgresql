...
function notificationIconComponent() {
  ...
  `);
    ...
    // DOM Selectors
    // =============================================================================
    const notificationBadgeSelector = component.querySelector('[data-id="notification-badge"]');
    const notificationBellSelector = component.querySelector('[data-id="notification-bell"]');
    if (notificationBadgeSelector && window.app.state.notificationCount !== 0) {
        notificationBadgeSelector.textContent = String(window.app.state.notificationCount);
