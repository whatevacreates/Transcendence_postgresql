...
function textNotifComponent(notification) {
    var _a;
    if (!notification || !notification.context) {
        console.error("Invalid notification passed to textNotifComponent:", notification); // 🛠️ Added guard clause
...
`);
    ...
    closeBtn === null || closeBtn === void 0 ? void 0 : closeBtn.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
