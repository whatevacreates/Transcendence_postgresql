...
function interactiveNotifComponent(notification) {
    var _a, _b, _c;
    const bgColor = notification.context === "friendship"
        ? "accentColour"
        : notification.context === "match"
            ? "secondaryText"
            : "secondaryText";
    const pictogram = notification.context === "friendship"
...
`);
    const currentUserId = (_a = window.app.state.user) === null || _a === void 0 ? void 0 : _a.id;
    const senderId = notification.user;
    // Button event listeners
    (_b = element
        .querySelector('[data-id="accept-btn"]')) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            ...
            //test
            console.log("query backend for possible mutual invitation between users: ", currentUserId, parseInt(senderId, 10));
            //
            yield api.deleteNotifForMutualInvitation(currentUserId, parseInt(senderId, 10));
            yield api.deleteMutualInvitation(currentUserId, parseInt(senderId, 10));
            yield api.acceptInvitation(notification.invitationId);
            yield api.deleteHandledNotif(notification.notifId, currentUserId);
            element.remove();
            updateNotifStack(notification.notifId);
            if (window.app.state.notificationCount &&
            ...
            if (((_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.includes("404")) || (error === null || error === void 0 ? void 0 : error.status) === 404) {
    ...
    (_c = element
        .querySelector('[data-id="decline-btn"]')) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            ...
            yield api.deleteNotifForMutualInvitation(currentUserId, parseInt(senderId, 10));
            yield api.deleteMutualInvitation(currentUserId, parseInt(senderId, 10));
            yield api.declineInvitation(notification.invitationId);
            //test
            console.log("declined invitation, ready to delete handled notification");
            //
            yield api.deleteHandledNotif(notification.notifId, currentUserId);
            element.remove();
            updateNotifStack(notification.notifId);
