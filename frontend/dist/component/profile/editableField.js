...
// Component
// =============================================================================
function createEditableField(key, initialValue) {
    ...
    `);
    let valueElement = container.querySelector(`[data-id="value-${key}"]`);
    const button = container.querySelector(`[data-id="edit-${key}-button"]`);
    let isEditing = false;
    function handleSave(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield api.updateUser(window.app.state.user.id, key, newValue);
                if (!result.ok) {
    ...
    function resetToDisplay(value, input) {
