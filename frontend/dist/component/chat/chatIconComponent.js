...
function chatIconComponent() {
  ...
  `);
    ...
    const chatBadgeSelector = component.querySelector('[data-id="chat-badge"]');
    // =============================================================================
    // Events
    // =============================================================================
    ...
    if (!window.app.chatListenerAdded) {
        const handleChat = (event) => {
            ...
            const currentUserId = Number((_a = window.app.state.user) === null || _a === void 0 ? void 0 : _a.id);
            ...
            window.app.state.unreadMessageCount = ((_b = window.app.state.unreadMessageCount) !== null && _b !== void 0 ? _b : 0) + 1;
            const current = (_c = window.app.state.unreadByUser[senderId]) !== null && _c !== void 0 ? _c : 0;
            ...
            const badge = document.querySelector('[data-id="chat-badge"]');
            if (badge) {
